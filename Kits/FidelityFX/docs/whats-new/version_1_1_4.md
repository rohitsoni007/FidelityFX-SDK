<!-- @page page_whats-new_index AMD FidelityFX™ SDK: What's new in AMD FidelityFX™ SDK 1.1.4 -->
...
<h3>AMD FidelityFX™ Brixelizer GI 1.0.1</h3>
Fixes an assertion when start cascade == end cascade.

<h3>AMD FidelityFX™ Breadcrumbs 1.0.1</h3>
...
<!-- - @subpage page_whats-new_index_1_1_4 "AMD FidelityFX™ SDK: What's new in AMD FidelityFX™ SDK 1.1.4" -->