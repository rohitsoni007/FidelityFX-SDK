<!-- @page page_whats-new_index AMD FidelityFX™ SDK: What's new in AMD FidelityFX™ SDK 2.0.0 -->

<h1>What's new in the AMD FidelityFX™ SDK 2.0.0?</h1>

Welcome to the AMD FidelityFX™ SDK. This major revision to the SDK serves as a launching pad for all of our new and upcoming DLL-based ML technologies. We are pleased to present the first of these with the public release of AMD FidelityFX™ FSR4.

<h2>New effects and features</h2>

<h3>AMD FidelityFX™ Super Resolution 4 (FSR 4.0.2)</h3>
Introducing our new inference-based AMD FidelityFX™ Super Resolution 4, an advanced upscaling solution that leverages state-of-the-art machine learning algorithms to generate high-quality, high-resolution frames from lower-resolution inputs.
...
Starting with AMD FidelityFX™ SDK 2.0.0 the effects, previously combined in amd_fidelityfx_dx12.dll, are split into multiple DLLs based on effect type. Please see [Introduction to AMD FidelityFX™ API](../getting-started/ffx-api.md#dlls-structure) for details.
<br/>
<br/>
...
<!-- - @subpage page_whats-new_index_2_0_0 "AMD FidelityFX™ SDK: What's new in AMD FidelityFX™ SDK 2.0.0" -->