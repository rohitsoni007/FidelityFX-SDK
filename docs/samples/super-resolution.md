...
![alt text](media/super-resolution/fsr3-sample.jpg "A screenshot of the AMD FSR™ Upscaling and Frame Generation Sample.")

This sample demonstrates the use of AMD FSR™ Upscaling 4.1.1 (and 3.1.5 & 2.3.4) for upscaling and AMD FSR™ Frame Generation 4.0.1 (and 3.1.6).
...
| **AMD FSR™ Version** | `3.1.5`, `2.3.4` | Select the AMD FSR™ upscaler version to use. |
...
The sample contains a [dedicated Render Module for AMD FSR™](../../Samples/Upscalers/FidelityFX_FSR/dx12/fsrapirendermodule.h) which creates the contexts and controls their lifetime. See the AMD FSR™ Upscaling Overview and Integration document for more information.
