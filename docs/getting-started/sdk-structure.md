<!-- @page page_getting-started_sdk-structure AMD FSR™ SDK Structure -->

<h1>AMD FSR™ SDK Structure</h1>

The AMD FSR™ SDK is comprised of several main components, organized to make sure you have a good experience exploring and learning about the different techniques implemented by the SDK. 
...
The SDK contains everything needed to ship all of our AMD FSR™ effects in your application:
...
A collection of pre-built runtime libraries to automate the usage of the AMD FSR™ SDK and make integration as simple as possible.
...
The AMD FSR™ SDK comes complete with numerous examples which demonstrate use of the effects implemented by the SDK. 

The AMD FSR™ SDK features a collection of sample applications in the **Samples** sub-folder which are dependent on the **AMD FSR™ SDK** headers and DLLs. Each sample application demonstrates how a technique (or techniques) should be integrated into your application. The samples present lots of options to allow you to evaluate and explore the technique before undertaking an integration.

<h3>Dependencies</h3>

The AMD FSR™ SDK samples are dependent upon our backing Cauldron Framework and various common render modules. 
...
Simply run the ```UpdateMedia.bat``` file in the root directory to fetch the latest version of the AMD FSR™ SDK content.
